  ...
  <div>
      ...
      <div class="filter-bar">
        ...
        <div class="sortby-div">
          ...
          <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center" @click="sortBy(5)">Rating</button>
        </div>
      </div>
      <div class="grid-list">
...
created(){
  ...
  axios.get(`http://localhost:3001/user-list?list=1&user=${username}`)
    .then(response => {
