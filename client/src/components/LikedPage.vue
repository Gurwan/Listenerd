  ...
  <div>
      ...
      <div class="filter-bar">
        ...
        <div class="sortby-div">
          ...
          <button id="button_sort_rating" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center" @click="sortBy(5)">Your rating</button>
        </div>
        <div class="hide-div">
          <p id="hide-p">SHOW</p>
...
created(){
  ...
  methods: {
    ...
    sortBy(arg){
      ...
      let ratingButton = document.getElementById("button_sort_rating");
      if(arg == 1){
        ...
        ratingButton.style.backgroundColor = "rgb(209, 213, 219)";
        ratingButton.style.color = "rgb(31, 41, 55)";
      } else if(arg == 4) {
        ...
        ratingButton.style.backgroundColor = "red";
